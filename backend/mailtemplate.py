...
COPY = {
    "en": {
        ...
        "reset": ("Put this code to reset your password on AethelHost!", "Enter this code below, then choose a new password!"),
    ...
    "pt": {
        ...
        "reset": ("Use este código para redefinir a sua senha no AethelHost!", "Digite o código abaixo e escolha uma nova senha!"),
